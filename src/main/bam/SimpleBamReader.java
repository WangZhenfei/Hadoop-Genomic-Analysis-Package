...
import fi.tkk.ics.hadoop.bam.cli.plugins.chipster.SummarySort;
...
public final class SimpleBamReader extends CLIPlugin {
    ...
    private static final CmdLineParser.Option
            ...
            sortOpt        = new CmdLineParser.Option.BooleanOption('s', "sort"),
            outputDirOpt   = new CmdLineParser.Option.StringOption('o', "output-dir=PATH"),
            noTrustExtsOpt = new CmdLineParser.Option.BooleanOption("no-trust-exts");

    public SimpleBamReader() {
            ...
            throws IOException, ClassNotFoundException, InterruptedException
    {
        ...
        job.setJarByClass  (SimpleBamReader.class);
        ...
        // This basically splits the data up into separate files? - WLSL
        ...
        extends Reducer<LongWritable,Range, NullWritable,RangeCount>
{
            ...
            Reducer<LongWritable,Range, NullWritable,RangeCount>.Context ctx)
    {
        ...
        for (String s : ctx.getConfiguration().getStrings(SUMMARY_LEVELS_PROP)) {
            ...
            summaryGroupsR.add(
                    new SummaryGroup(lvl, SimpleBamReader.getOutputName(s, false)));
            summaryGroupsF.add(
                    new SummaryGroup(lvl, SimpleBamReader.getOutputName(s,  true)));
        }
    }
